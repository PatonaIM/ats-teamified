...
- **LinkedIn Integration:** A feature-flagged system (`LINKEDIN_ENABLED`) supporting employment type-specific formatting, automatic posting workflows, sync status tracking, and exponential backoff retry logic. LinkedIn posting is automatically triggered upon job approval for client-submitted jobs.
